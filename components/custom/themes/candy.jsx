...
function CopyWallet({ wallet }) {
  ...
  return (
    <div>
      <div className="flex align-middle items-center border  border-[#FFAFCC] rounded-3xl">
        <div className="bg-[#BDE0FE]/40 p-2 pl-3 rounded-l-3xl w-full hover:bg-black/10 duration-500 select-none truncate">
          {wallet.address}
        </div>
        <div>
          <Button
