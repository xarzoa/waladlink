...
export default function Info() {
  return (
    <div className="info-bg rounded-none relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 place-items-start cursor-help text-neutral-400 backdrop-blur-3xl divide-solid md:divide-none divide-y font-semibold font-gabarito text-sm md:text-base">
        <div className="p-6">
